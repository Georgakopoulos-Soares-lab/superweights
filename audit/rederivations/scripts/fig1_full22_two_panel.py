...
same raw model-name strings):
  - audit/rederivations/fig1c_random_vs_topk_gaps_full22.csv
  ...
  - results/experiments/E11/scale_ladder_controls.csv               -- 5 random-control q1 rows,
    audit/rederivations/section2_random_control_q1_batch2.csv     original-12 / batch2-10 models.
  - audit/rederivations/topk_norm_q1_summary.csv                -- 5 top-norm-by-rank control q1
    rows per model (coord_role rank2_by_norm..rank6_by_norm), all 22 models in one file.

Output:
  audit/rederivations/figures/fig1c_full22_two_panel.{png,pdf}
  audit/rederivations/figures/fig1_panel_c_full22_source.csv
