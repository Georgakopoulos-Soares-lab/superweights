...
output. Produces its own PNG/PDF in audit/rederivations/figures/.
...
from audit/rederivations/fig1c_random_vs_topk_gaps_full22.csv) so panel position is directly
cross-referenceable between the two figures.

Data: audit/rederivations/structural_vs_causal_gap.csv (44 rows = 22 models x 2 epsilons).
Output:
  audit/rederivations/figures/fig2_topnorm_panel.{png,pdf}
  audit/rederivations/figures/fig2_panel_d_source.csv
