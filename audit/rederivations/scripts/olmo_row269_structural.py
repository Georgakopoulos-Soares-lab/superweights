...
audit/rederivations/section3_text_decoder_calibration.json under a new "structural_comparison" key.
"""
...
OUT = ROOT / "audit/rederivations/section3_text_decoder_calibration.json"
