...
unchanged). Appends to audit/round2/topk_norm_controls.csv and
audit/round2/topk_norm_q1_summary.csv; checkpointed so it can be resumed/extended to more
...
OUT_CSV = ROOT / "audit/round2/topk_norm_controls.csv"
SUMMARY_CSV = ROOT / "audit/round2/topk_norm_q1_summary.csv"
CANDIDATE_CSV = ROOT / "results/E11/scale_ladder.csv"
