...
DAMAGE_MATCHING = ROOT / "results/E12/damage_matching.csv"
DAMAGE_EVALS = ROOT / "results/E12/raw/damage_evals.jsonl"
DOSE = ROOT / "results/E12/dose_response_extended.csv"
OUT = ROOT / "audit/round2/generator_random_direction_grid.csv"
