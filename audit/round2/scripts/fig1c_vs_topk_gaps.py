#!/usr/bin/env python
"""Emit audit/round2/fig1c_random_vs_topk_gaps.csv: for each of the 12 E11-panel models,
...
OUT = ROOT / "audit/round2/fig1c_random_vs_topk_gaps.csv"
...
topk = list(csv.DictReader(open(ROOT / "audit/round2/topk_norm_q1_summary.csv")))
