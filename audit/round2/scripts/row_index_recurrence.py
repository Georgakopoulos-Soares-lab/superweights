...
Yu et al.'s published Table 2 (see experiments/frozen/E10_nlp_architecture_causal/
...
OUT = ROOT / "audit/round2/row_index_recurrence.csv"
...
RECORDS = [
    ...
    ("OLMo-7B -- mostly circular, ONE new instance", 4096,
     ...
     "(audit/round2/section3_text_decoder_calibration.json) -- not in Yu et al.",
     True,
    ...
    ("NTv3 -- fully independent, genomic (untested by Sun et al. or Yu et al.)", 1536,
     [(11, 1472), (6, 1472)],
     "Both layers found by this session's own detector runs (audit/round2/"
