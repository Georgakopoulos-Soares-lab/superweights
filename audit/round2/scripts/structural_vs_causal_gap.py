...
results/E13/raw_4b/*.json dynamically, so no model list to maintain by hand.
"""
...
OUT = ROOT / "audit/round2/structural_vs_causal_gap.csv"
...
structural = {r["model"]: float(r["topk_gap"])
              for r in csv.DictReader(open(ROOT / "audit/round2/full22_topk_gap_confounds.csv"))}
census = {r["model"]: r
