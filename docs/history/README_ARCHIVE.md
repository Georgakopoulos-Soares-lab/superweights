# README archive (pre-2026-09-09)

The repository README accreted chronologically across sessions and reached 1,443 lines,
which made it unusable as an entry point. It was replaced with a concise, reviewer-facing
README on 2026-09-09 and is preserved here **in full and unedited** so that no experimental
detail, negative result, or historical caveat is lost. Numbers here have not been re-checked
against the retractions list; consult the current README and `docs/EXPERIMENT_MAP.md` first.
