...
expanded here from ``results/experiments/E7/e7_phi3_spectral.json`` and their layer-relative norms are
joined from ``results/experiments/E13/phi3_layer_median_breakdown.json``.  No causal artifact is read.
"""
...
ROOT = HERE.parents[1]
SOURCE = ROOT / "results" / "experiments" / "E11" / "scale_ladder_backfilled.csv"
PHI_SPECTRAL = ROOT / "results" / "e7_phi3_spectral.json"
PHI_NORMS = ROOT / "results" / "experiments" / "E13" / "phi3_layer_median_breakdown.json"
OUT = ROOT / "results" / "experiments" / "E13" / "candidate_manifest.json"
