...
def from_exact_uknorm_json(model_key: str, layer: int, row: int) -> dict:
    """OLMo / Phi-3: results/experiments/E10/e10_exact_uknorm_{model_key}.json, Gram-identity exact, all rows."""
...
def from_encoder_row_ranking_json(model_key: str, layer: int, row: int) -> dict:
    """MosaicBERT / ModernBERT-base: results/experiments/E10/e10_encoder_row_ranking_{model_key}.json,
