...
def write_note(rows: list[dict], anchors: dict, structural: dict, sink: dict) -> None:
    ...
    lines = [
        ...
        "- `experiments/figures/main/fig4_generator_specificity.pdf`",
        "- `results/experiments/E12/figure4_generator_specificity_panel_c.csv`",
        "- `experiments/figures/fig4_generator_specificity.py`", "",
    ]
    NOTE.write_text("\n".join(lines))
