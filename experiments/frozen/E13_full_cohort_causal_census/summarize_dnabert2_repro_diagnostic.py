...
def main() -> None:
    ...
    lines = [
        ...
        "- `experiments/frozen/E13_full_cohort_causal_census/run_dnabert2_repro_diagnostic.py`",
        "- `experiments/frozen/E13_full_cohort_causal_census/summarize_dnabert2_repro_diagnostic.py`",
    ]
