...
Combines the 12 newly measured E11 ladder models (results/experiments/E11/raw/*.json, produced by
...
CSVs. Writes:
  results/experiments/E11/scale_ladder.csv
  results/experiments/E11/scale_ladder_controls.csv

Cited-model numbers are transcribed by hand from:
  results/experiments/E7/e7_phase1_detection_qwen25.json, results/experiments/E7/e7_phase1_detection_genomeocean.json
  results/experiments/E7/e7_legacy_reanalysis.json (Llama-7B, Mistral-7B, OLMo-7B, GENERator-EUK-3B, DNABERT-2, NTv3)
...
RAW_DIR = ROOT / "results" / "experiments" / "E11" / "raw"
OUT_DIR = ROOT / "results" / "experiments" / "E11"
...
CITED = [
    dict(model="Llama-7B", repo="huggyllama/llama-7b", revision="unpinned (E5/E6 original)",
         ...
         source="results/experiments/E7/e7_legacy_reanalysis.json"),
    ...
    dict(model="Qwen2.5-7B", repo="Qwen/Qwen2.5-7B", revision="d149729398750b98c0af14eb82c78cfe92750796",
         ...
         source="results/experiments/E7/e7_phase1_detection_qwen25.json"),
    ...
    dict(model="GenomeOcean-4B", repo="DOEJGI/GenomeOcean-4B", revision="2bed2fc3ed47c5f6955ba3e64563512c9b338dfb",
         ...
         source="results/experiments/E7/e7_phase1_detection_genomeocean.json"),
]
for c in CITED:
...
def load_measured():
    ...
    for key in PANEL_ORDER:
        ...
        row = dict(
            ...
            source=f"results/experiments/E11/raw/{key}.json", source_type="measured",
