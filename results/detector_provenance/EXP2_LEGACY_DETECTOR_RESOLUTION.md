...
Scripts: `scripts/detection/run_uniform_detector_text.py` (the 3 text decoders + a
positive control) and `scripts/detection/run_uniform_detector.py` (the 2 genomic models).
