...
Raw artifacts:
- Priority 1: `results/experiments/E13/priority1_robustness/priority1_robustness_results.json`
- Priority 2: `results/experiments/E13_candidate_stability/*.json` (20 files)
- Priority 3: `results/experiments/E_BOS_MEDIATION/{provenance_check,smoke_tests,bos_mediation_results}.json`
...
`results/experiments/E7/e7_legacy_reanalysis.json`, which carries published/structural coordinates and has
