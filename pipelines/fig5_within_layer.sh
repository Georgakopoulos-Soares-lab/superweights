...
results/analyses/within_layer_sweep/within_model_slope_smollm2_1.7b.json|fig5_sweep_text|$PY_GENERATOR|scripts/within_layer_sweep/run_within_model_slope_text.py
results/analyses/within_layer_sweep/within_model_slope.json|fig5_sweep_genomic|$PY_GENERATOR|scripts/within_layer_sweep/run_within_model_slope.py
results/analyses/within_layer_sweep/smollm2_second_row_epistasis.json|fig5_second_row|$PY_GENERATOR|scripts/within_layer_sweep/run_smollm2_second_row_epistasis.py
EOF

stage results/analyses/within_layer_sweep/smollm2_161_749_geometry.json fig5_geometry \
      "$PY_GENERATOR" scripts/within_layer_sweep/run_smollm2_row_geometry.py

FORCE=1 stage results/analyses/within_layer_sweep/fig_within_model_slope_2panel.pdf fig5_plot \
      "$PY_GENERATOR" scripts/within_layer_sweep/plot_within_model_slope_2panel.py
log "done -- figure at results/analyses/within_layer_sweep/fig_within_model_slope_2panel.{png,pdf}"
