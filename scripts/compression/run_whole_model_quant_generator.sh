...
echo "=== GENERator eukaryote: SW-exemption quantization comparison (INT4) ==="
date
...
python scripts/compression/run_whole_model_quantization.py \
    ...
    --out        results/whole_model_quant_generator_sw_comparison.json \
    --plot       results/whole_model_quant_generator_sw_comparison.png \
    --verify_quant
