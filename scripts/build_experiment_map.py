...
M = [
 ("S1", "Row-associated bilinear operator; exact q1, PR_spec, Frobenius norm",
  ...
  ["experiments/E7_exact_dimensionality/run_legacy_reanalysis.py",
   ...
   "experiments/E7_exact_dimensionality/spectral_lib.py"],
  ["results/experiments/E7/e7_legacy_reanalysis.json",
 ...
 ("S3", "23-model structural panel (scale ladder)",
  ...
  ["results/experiments/E11/scale_ladder_backfilled.csv"],
 ...
 ("C1", "22-model singleton causal census, candidate + 5 random same-layer controls, eps 0.5/1.0",
  "Fig 2A,B",
  ["experiments/E13_full_cohort_causal_census/run_singleton_census.py",
   "experiments/E13_full_cohort_causal_census/build_candidate_manifest.py",
   "experiments/E13_full_cohort_causal_census/compile_census.py"],
  ["results/experiments/E13/part2_22_model_results.csv", "audit/census_master.csv"],
 ...
 ("C2", "Top-norm control set: 5 highest-Frobenius same-layer rows, no forward pass",
  "Fig 2D",
  ["experiments/E13_full_cohort_causal_census/run_priority1_robustness.py"],
 ...
 ("C3", "q1 vs signed full-ablation effect across the panel",
  "Fig 2C",
  ["experiments/E13_full_cohort_causal_census/build_cohort_summary.py"],
 ...
 ("D1", "Activation-ratio detector, per-row over all layers (candidate provenance)",
  "Methods",
  ["experiments/E13_full_cohort_causal_census/run_rowwise_detector.py"],
 ...
 ("D2", "Legacy vs ratio rule resolved for all 6 legacy models, with paired causal evaluation",
  ...
  ["results/analyses/detector_provenance/uniform_detector_text_llama.json",
   "results/analyses/detector_provenance/uniform_detector_text_mistral.json",
   "results/analyses/detector_provenance/uniform_detector_text_olmo.json",
   "results/analyses/detector_provenance/uniform_detector_dnabert2.json",
   "results/analyses/detector_provenance/uniform_detector_ntv3.json",
   "results/analyses/detector_provenance/detector_published_protocol.json",
   "audit/detector_provenance_exp2_resolution.csv",
   "results/analyses/detector_provenance/EXP2_LEGACY_DETECTOR_RESOLUTION.md"],
 ...
 ("D3", "Candidate input stability over 24 domain-matched inputs",
  "Methods",
  ["experiments/E13_full_cohort_causal_census/run_candidate_input_stability.py"],
  ["results/experiments/E13_candidate_stability"],
 ...
 ("D4", "OLMo coordinate-substitution sensitivity of the cohort correlations",
  ...
  ["results/analyses/detector_provenance/exp2_olmo_exposure_sensitivity.json"],
 ...
 ("M3", "GENERator L4/r2371 BOS mediation and position rescue",
  ...
  ["results/experiments/E_BOS_MEDIATION/bos_mediation_results.json",
   "results/analyses/mechanism_generator/generator_position_rescue.json",
   "results/analyses/mechanism_generator/generator_bos_identity_vs_position.json",
 ...
 ("M4", "GENERator GC composition and damage-matched random-direction replacement",
  ...
  ["results/analyses/mechanism_generator/generator_random_direction_replicates.json",
   "results/experiments/E12/damage_matching.csv"],
 ...
 ("M5", "Attention-sink diagnostics at the GENERator SW position",
  ...
  ["results/analyses/mechanism_generator/generator_attention_sink.json"],
 ...
 ("W1", "Within-layer graded sweep, 36 rows log-spaced by ratio rank, two decoders",
  ...
  ["results/analyses/within_layer_sweep/within_model_slope.json",
   "results/analyses/within_layer_sweep/within_model_slope_smollm2_1.7b.json",
   "results/analyses/within_layer_sweep/within_model_slope_comparison.json",
   "results/analyses/within_layer_sweep/fig_within_model_slope_2panel.pdf",
 ...
 ("W2", "Second critical row r161 and the r161/r749 masking interaction, with geometry",
  ...
  ["results/analyses/within_layer_sweep/smollm2_second_row_epistasis.json",
 ...
 ("P1", "Phi-3 six-row basis and its tomography (not used for any cohort claim)",
  "Fig S1A; Note S1",
  ["experiments/E10b_phi3_tomography/run_phi3_tomography.py",
   "experiments/E7_exact_dimensionality/run_phi3_spectral.py"],
  ["results/experiments/E10/e10b_phi3_tomography_responses.json",
 ...
 ("P2", "Per-model random-control causal detail for the decoder audit",
  "Fig S1B",
  ["experiments/E10_nlp_architecture_causal/run_decoder_spectrum.py"],
  ["results/experiments/E10/e10_decoder_control_rows.json"],
 ...
 ("A1", "Cohort structure-function correlations and figures",
  ...
  ["scripts/census_analysis/run_activation_vs_causality.py",
   "scripts/census_analysis/run_census_analyses.py"],
  ["results/analyses/census_analysis/activation_vs_causality.tsv",
   "results/analyses/census_analysis/activation_vs_causality_per_model.tsv",
   "results/analyses/census_analysis/family_clustered_sensitivity.tsv"],
