...
paper-salvage/docs/MISSING_COLLEAGUE_ARTIFACTS.md). Those rows are reported as
...
M = [
 ("S1", "Row-associated bilinear operator; exact q1, PR_spec, Frobenius norm",
  "Fig 1B,C",
  ["paper-salvage/experiments/E7_exact_dimensionality/run_legacy_reanalysis.py",
   "paper-salvage/experiments/E7_exact_dimensionality/run_phase1_detection.py",
   "paper-salvage/experiments/E7_exact_dimensionality/spectral_lib.py"],
  ["results/e7_legacy_reanalysis.json",
   "paper-salvage/figures/source_data/fig1_structural.json"],
  "Exact spectrum, no diagonal approximation."),

 ("S2", "Retrospective diagonal-proxy calibration on published NLP super weights",
  "Fig 1A",
  ["paper-salvage/experiments/E1_nlp_validation"],
  ["paper-salvage/figures/source_data/fig1_structural_panel_a.csv"],
  "Calibration only; numerically distinct from the exact metric in Fig 1B,C."),

 ("S3", "23-model structural panel (scale ladder)",
  "Fig 1B",
  ["paper-salvage/experiments/E11_scale_ladder/run_model.py",
   "paper-salvage/experiments/E11_scale_ladder/build_csv.py"],
 ...
 ("C1", "22-model singleton causal census, candidate + 5 random same-layer controls, eps 0.5/1.0",
  ...
  ["paper-salvage/experiments/E13_full_cohort_causal_census/run_singleton_census.py",
   ...
   "paper-salvage/experiments/E13_full_cohort_causal_census/compile_census.py"],
 ...
 ("C2", "Top-norm control set: 5 highest-Frobenius same-layer rows, no forward pass",
  "Fig 2D",
  ["paper-salvage/experiments/E13_full_cohort_causal_census/run_priority1_robustness.py"],
 ...
 ("C3", "q1 vs signed full-ablation effect across the panel",
  "Fig 2C",
  ["paper-salvage/experiments/E13_full_cohort_causal_census/build_cohort_summary.py"],
  ["paper-salvage/figures/source_data/fig2_causal.json"],
  "The structure-function dissociation; rho = 0.074."),

 ("D1", "Activation-ratio detector, per-row over all layers (candidate provenance)",
  "Methods",
  ["paper-salvage/experiments/E13_full_cohort_causal_census/run_rowwise_detector.py"],
 ...
 ("D3", "Candidate input stability over 24 domain-matched inputs",
  "Methods",
  ["paper-salvage/experiments/E13_full_cohort_causal_census/run_candidate_input_stability.py"],
 ...
 ("M1", "DNABERT-2 pretrained MLM pair L9/r264 + L9/r294; joint ablation and epistasis",
  "Fig 3A,B",
  ["paper-salvage/experiments/E9_mechanistic_tomography/run_dnabert2_measurements.py",
   "scripts/mechanism/run_pretrained_epistasis.py"],
  ["paper-salvage/figures/source_data/fig3_dnabert.json"],
 ...
 ("M2", "Finite-intervention tomography, observer families F0-F3 on a fixed 10-row basis",
  "Fig 3C,D",
  ["paper-salvage/experiments/E9_mechanistic_tomography/run_fit_observers.py",
 ...
 ("M3", "GENERator L4/r2371 BOS mediation and position rescue",
  "Fig 4",
  ["paper-salvage/experiments/E12_generator_degradation_control/run_bos_mediation_main.py",
   "paper-salvage/experiments/E12_generator_degradation_control/run_e12_full.py",
  ...
  ["results/E_BOS_MEDIATION/bos_mediation_results.json",
   ...
   "paper-salvage/figures/source_data/fig4_generator.json"],
 ...
 ("M4", "GENERator GC composition and damage-matched random-direction replacement",
  ...
  ["scripts/paper_closing/run_random_directions.py",
   "paper-salvage/figures/supplement/fig_s2_random_direction.py"],
 ...
 ("P1", "Phi-3 six-row basis and its tomography (not used for any cohort claim)",
  "Fig S1A; Note S1",
  ["paper-salvage/experiments/E10b_phi3_tomography/run_phi3_tomography.py",
   "paper-salvage/experiments/E7_exact_dimensionality/run_phi3_spectral.py"],
  ["results/e10b_phi3_tomography_responses.json",
   "paper-salvage/figures/source_data/fig_s1_structural_detail.json"],
  "Full-ablation response treated as unresolved."),

 ("P2", "Per-model random-control causal detail for the decoder audit",
  "Fig S1B",
  ["paper-salvage/experiments/E10_nlp_architecture_causal/run_decoder_spectrum.py"],
