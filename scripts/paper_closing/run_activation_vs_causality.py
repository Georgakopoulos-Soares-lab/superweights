...
os.makedirs(os.path.join(ROOT, "results/paper_closing"), exist_ok=True)
tsv = os.path.join(ROOT, "results/paper_closing/activation_vs_causality.tsv")
...
per = os.path.join(ROOT, "results/paper_closing/activation_vs_causality_per_model.tsv")
