...
Source: results/e7_phi3_spectral.json, results/e10_decoder_concentration.json,
        paper-salvage/figures/source_data/fig1_structural_panel_bcd.csv (written by
        paper-salvage/figures/fig1_structural.py).
