...
preregistration ledger entries; it does not touch `paper-salvage/results/`,
`paper-salvage/docs/CLAIMS_LEDGER.md`, `PAPER_OUTLINE.md`, or `CLAUDE.md`. Nothing in the
