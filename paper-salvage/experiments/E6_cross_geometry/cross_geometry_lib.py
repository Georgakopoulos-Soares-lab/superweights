...
Reuses paper-salvage/experiments/E5_dimensionality/dimensionality_lib.py's already-validated
exact_uk_all_rows() for the layer-wide reference distribution (Task 2F), and
paper-salvage/src/uk_frobenius.py's uk_frobenius() for the diagonal form -- per instruction,
