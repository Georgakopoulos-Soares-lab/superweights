...
(`scripts/detection/`, `results/`, `paper-salvage/results/` all searched). Compare:
...
absent) — consistent with `paper-salvage/docs/MISSING_COLLEAGUE_ARTIFACTS.md`. C-040's
...
Explicitly noted in `paper-salvage/CLAUDE.md:62` / `CLAIMS_LEDGER.md:77`: this 10-row set is
