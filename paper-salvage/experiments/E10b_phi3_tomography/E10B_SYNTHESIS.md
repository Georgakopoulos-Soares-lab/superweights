...
(`results/e10b_phi3_fit_results.json`). Governing lock:
...
the 3** layer-2 rows — stays in the +0.02 to +1.1 range (`results/e10b_phi3_tomography_responses.json`).
...
| Artifact | Path |
|---|---|
| Basis audit | `paper-salvage/experiments/E10b_phi3_tomography/PHI3_BASIS_AUDIT.md` |
| Locked prereg | `paper-salvage/docs/prereg/PREREG_E10b_phi3_tomography.md` (sha256 `098fd52c...`) |
| Mask design + validity checks | `paper-salvage/experiments/E10b_phi3_tomography/masks_phi3.json` |
| Raw per-mask, per-batch responses (both epsilons) | `results/e10b_phi3_tomography_responses.json` |
| F0-F3 coefficients, metrics, bootstrap, retrospective pairs | `results/e10b_phi3_fit_results.json` |
| Measurement script | `paper-salvage/experiments/E10b_phi3_tomography/run_phi3_tomography.py` |
| Fitting script | `paper-salvage/experiments/E10b_phi3_tomography/fit_phi3_observers.py` |
| Mask-generation library | `paper-salvage/experiments/E10b_phi3_tomography/mask_lib_e10b.py` |
