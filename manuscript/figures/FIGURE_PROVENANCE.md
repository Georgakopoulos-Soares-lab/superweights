...
Shared model-class visual encoding: `manuscript/figures/_paper_encoding.py`.
...
Authoritative absence record for the colleague-branch items still missing: `manuscript/docs/MISSING_COLLEAGUE_ARTIFACTS.md`.
