...
`manuscript/figures/supplement/fig_s1_structural_detail.py` as Supplementary Fig. S1C.
"""
...
def main():
    ...
    # panel C source data already lives at manuscript/figures/source_data/fig1_panel_c_full22_source.csv
