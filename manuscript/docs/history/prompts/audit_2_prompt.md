...
`manuscript/experiments/{E11_scale_ladder,E12_generator_degradation_control,E13_full_cohort_causal_census}/`
...
Note explicitly: `manuscript/docs/MANUSCRIPT_SOURCE_OF_TRUTH.md` (99KB, untracked) is almost
...
Following this project's own convention in `manuscript/CLAUDE.md` (results are gitignored;
keepers get `git add -f`):

1. Commit the experiment code: `manuscript/experiments/{E11_scale_ladder,E12_generator_degradation_control,E13_full_cohort_causal_census}/`
