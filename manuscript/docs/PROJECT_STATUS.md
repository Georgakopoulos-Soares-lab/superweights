...
cleanly; `manuscript/` never overlapped with it (zero path collision, confirmed by the
...
4. `manuscript/CLAUDE.md` rewritten: new thesis, new hard-constraint section listing every
...
New, self-contained experiment directory: `manuscript/experiments/E5_dimensionality/`
...
New, self-contained experiment: `manuscript/experiments/E6_cross_geometry/`.
...
9 DNABERT-2 rows). New, self-contained experiment: `manuscript/experiments/
...
New experiment: `manuscript/experiments/E8_encoder_decoder/`, testing the one clean
...
`manuscript/` does not exist on the colleague branch or at the merge-base — zero path
