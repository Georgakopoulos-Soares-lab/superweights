...
def main() -> None:
    ...
    provenance = {
        ...
        "raw_outputs": {name: {"path": f"results/E13_dnabert2_reproducibility/{name}.json",
    ...
    lines = [
        ...
        "- `manuscript/experiments/E13_full_cohort_causal_census/run_dnabert2_repro_diagnostic.py`",
        "- `manuscript/experiments/E13_full_cohort_causal_census/summarize_dnabert2_repro_diagnostic.py`",
    ]
