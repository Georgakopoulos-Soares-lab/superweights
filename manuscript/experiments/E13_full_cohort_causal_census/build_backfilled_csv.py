...
ROOT = SALVAGE.parent
CSV_IN = ROOT / "results" / "E11" / "scale_ladder.csv"
CSV_OUT = ROOT / "results" / "E11" / "scale_ladder_backfilled.csv"
BACKFILL_JSON = ROOT / "results" / "E13" / "layer_median_backfill.json"
PHI3_NOTE = ROOT / "results" / "E13" / "phi3_layer_median_breakdown.json"
