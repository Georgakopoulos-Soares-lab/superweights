...
(`scripts/detection/`, `results/`, `manuscript/results/` all searched). Compare:
...
absent) — consistent with `manuscript/docs/MISSING_COLLEAGUE_ARTIFACTS.md`. C-040's
...
Explicitly noted in `manuscript/CLAUDE.md:62` / `CLAIMS_LEDGER.md:77`: this 10-row set is
