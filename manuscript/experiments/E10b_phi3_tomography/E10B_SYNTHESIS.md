...
| Artifact | Path |
|---|---|
| Basis audit | `manuscript/experiments/E10b_phi3_tomography/PHI3_BASIS_AUDIT.md` |
| Locked prereg | `manuscript/docs/prereg/PREREG_E10b_phi3_tomography.md` (sha256 `098fd52c...`) |
| Mask design + validity checks | `manuscript/experiments/E10b_phi3_tomography/masks_phi3.json` |
...
| Measurement script | `manuscript/experiments/E10b_phi3_tomography/run_phi3_tomography.py` |
| Fitting script | `manuscript/experiments/E10b_phi3_tomography/fit_phi3_observers.py` |
| Mask-generation library | `manuscript/experiments/E10b_phi3_tomography/mask_lib_e10b.py` |
