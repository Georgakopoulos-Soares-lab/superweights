...
# ---------------------------------------------------------------------------
# ActivationMapCapturer — keeps full [B, C, L] for selected channels
# ---------------------------------------------------------------------------
...
class ActivationMapCapturer:
    ...
    Unlike summary capturers, this keeps only the selected channels and keeps
    the length dimension to support top-K localization.
    """
    ...
    def _hook(self, layer_name: str, channels: list):
